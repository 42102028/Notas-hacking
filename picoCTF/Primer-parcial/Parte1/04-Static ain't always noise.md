...
## Solución
Ejecutastmos el script `ltdis.sh` sobre el archivo `static` para desensamblarlo y extraer las cadenas de texto. Luego, usaste `grep` para filtrar y encontrar la línea que contiene "pico", revelando la flag mencionada.

```
arcf99-picoctf@webshell:~/noise$ ls    
ltdis.sh  static
arcf99-picoctf@webshell:~/noise$ ls -la
total 20
drwxrwxr-x 2 arcf99-picoctf arcf99-picoctf   36 Mar  3 20:06 .
drwxr-xr-x 3 arcf99-picoctf arcf99-picoctf 4096 Mar  3 20:06 ..
-rw-rw-r-- 1 arcf99-picoctf arcf99-picoctf  785 Mar 16  2021 ltdis.sh
-rw-rw-r-- 1 arcf99-picoctf arcf99-picoctf 8376 Mar 16  2021 static
arcf99-picoctf@webshell:~/noise$ chmod +x ltdis.sh
arcf99-picoctf@webshell:~/noise$ ./ltdis.sh static
Attempting disassembly of static ...
Disassembly successful! Available at: static.ltdis.x86_64.txt
Ripping strings from binary with file offsets...
Any strings found in static have been written to static.ltdis.strings.txt with file offset
arcf99-picoctf@webshell:~/noise$ cat static.ltdis.strings.txt
   ...
   1969 .bss
   196e .comment
arcf99-picoctf@webshell:~/noise$ cat static.ltdis.strings.txt grep pico
    238 /lib64/ld-linux-x86-64.so.2
    361 libc.so.6
    36b puts
    370 __cxa_finalize
